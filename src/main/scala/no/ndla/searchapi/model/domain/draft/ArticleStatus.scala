...
object ArticleStatus extends Enumeration {
  ...
  val IMPORTED, DRAFT, PUBLISHED, PROPOSAL, QUEUED_FOR_PUBLISHING, QUEUED_FOR_PUBLISHING_DELAYED, USER_TEST,
  AWAITING_QUALITY_ASSURANCE, QUEUED_FOR_LANGUAGE, TRANSLATED, QUALITY_ASSURED, QUALITY_ASSURED_DELAYED,
