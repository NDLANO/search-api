...
case class ArticleResults(@(ApiModelProperty@field)(description = "The type of search results (articles)") `type`: String,
...
case class LearningpathResults(@(ApiModelProperty@field)(description = "The type of search results (learningpaths)") `type`: String,
                               @(ApiModelProperty@field)(description = "The language of the search results") language: String,
...
case class AudioResults(@(ApiModelProperty@field)(description = "The type of search results (audios)") `type`: String,
                        @(ApiModelProperty@field)(description = "The language of the search results") language: String,
...
case class SearchError(@(ApiModelProperty@field)(description = "The api where the error occurred") `type`: String,
