...
case class ArticleSummary(@(ApiModelProperty@field)(description = "The unique id of the article") id: Long,
                          ...
                          @(ApiModelProperty@field)(description = "A metaDescription for the article") metaDescription: Option[MetaDescription],
